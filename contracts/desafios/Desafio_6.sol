...
contract AirdropOne is Pausable, AccessControl {
    ...
    IMiPrimerTKN public miPrimerTokenAdd;

    mapping(address => bool) public whiteList;
    mapping(address => bool) public haSolicitado;

    constructor(address _tokenAddress) {
        miPrimerTokenAdd = IMiPrimerTKN(_tokenAddress);
    ...
    function participateInAirdrop() public whenNotPaused {
        ...
        require(haSolicitado[msg.sender] == false, "Ya ha participado");
        ...
        require(airdropGivenSoFar + tokensToReceive < totalAirdropMax, "Excedido");
        ...
        miPrimerTokenAdd.mint(msg.sender, tokensToReceive);
    }

    function quemarMisTokensParaParticipar() public whenNotPaused {
        // verificar que el usuario aun no ha participado
        require(haSolicitado[msg.sender] == true, "Usted aun no ha participado");
        // Verificar si el que llama tiene suficientes tokens
        require(miPrimerTokenAdd.balanceOf(msg.sender) >= quemaTokensParticipar, "No tiene suficientes tokens para quemar");
        // quemar los tokens
        miPrimerTokenAdd.burn(msg.sender, quemaTokensParticipar);
        // dar otro chance
